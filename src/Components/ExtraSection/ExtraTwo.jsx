...
const ExtraTwo = () => {
    return (
      <div>
        <div className="text-[#9C77B7] body-font">
          <div className="container mx-auto flex flex-col px-5 py-24 justify-center items-center">
            <img
              className="lg:w-2/6  md:w-3/6 w-5/6 mb-10 object-cover object-center rounded-xl hover:border-2 "
            ...
            <div className="w-full md:w-2/3 flex flex-col mb-16 items-center text-center">
              ...
              <div className="flex w-full justify-center items-end">
                ...
                <button className="inline-flex  py-2 px-6 focus:outline-none bg-white hover:bg-transparent  hover:border-2  text-black hover:text-white rounded text-lg">
                  Button
                </button>
              </div>
              ...
              <div className="flex text-black">
                <button className="bg-white hover:bg-transparent hover:text-white hover:border-2 inline-flex py-3 px-5 rounded-lg items-center focus:outline-none">
                  <svg
                ...
                <button className="bg-white hover:bg-transparent hover:text-white hover:border-2 inline-flex py-3 px-5 rounded-lg items-center ml-4  focus:outline-none">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    className="w-6 h-6"
