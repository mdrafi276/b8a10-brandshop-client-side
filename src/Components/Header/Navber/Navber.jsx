...
const Navber = () => {
  ...
  useEffect(()=>{
   ...
   setMode(currentMode)
    ...
    return (
      <div className="backdrop-blur sticky dark:text-black dark:bg-white z-20 top-0 ">
        <div
          id="header-nav"
          className="  text-white dark:bg-black bg-transparent  "
        >
            ...
            <div className="navbar rounded-lg">
              <div className="navbar-start">
                ...
                >
                  ...
                  <span className="dark:text-black">ElectroElegance</span>
                </h1>
                <div className="dropdown">
                  ...
                  <ul
                    tabIndex={0}
                    className="menu menu-sm text-white dark:text-white dropdown-content text-black mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52"
                  >
                    {navLink}
                  </ul>
                </div>
                ...
                {user ? (
                  <div>
                    <button
                      ...
                      className="btn backdrop-blur dark:bg-black dark:hover:bg-black dark:text-white dark:hover:text-white  bg-transparent  text-white hover:bg-white hover:text-black "
                    >
                      LogOut
                    </button>
                  </div>
                  ...
                  <Link to="/login">
                    <button className="btn backdrop-blur dark:bg-black dark:hover:bg-black dark:text-white dark:hover:text-white  bg-transparent  text-white hover:bg-white hover:text-black ">
                      Login
                    </button>
                  </Link>
                )}
